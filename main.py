...
async def fetch_summary_message(client, channel, since_time, filter_rule):
    async for message in client.iter_messages(channel, offset_date=since_time):
...
async def main():
    ...
    async with TelegramClient('session_name', api_id, api_hash) as client:
        ...
        summary_message = await fetch_summary_message(client, 'hardcoded_summary_channel', since_time, filter_rule)
